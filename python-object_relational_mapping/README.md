...
guillaume@ubuntu:~/$ cat 100-relationship_states_cities.sql
...
guillaume@ubuntu:~/$ cat 100-relationship_states_cities.sql | mysql -uroot -p
Enter password:
ERROR 1146 (42S02) at line 5: Table 'hbtn_0e_100_usa.states' doesn't exist
guillaume@ubuntu:~/$ ./100-relationship_states_cities.py root root hbtn_0e_100_usa
guillaume@ubuntu:~/$ cat 100-relationship_states_cities.sql | mysql -uroot -p
Enter password:
id  name
1   California
...
guillaume@ubuntu:~/$ cat 101-relationship_states_cities_list.sql
...
guillaume@ubuntu:~/$ cat 101-relationship_states_cities_list.sql | mysql -uroot -p
guillaume@ubuntu:~/$ ./101-relationship_states_cities_list.py root root hbtn_0e_101_usa
1: California
    1: San Francisco
    2: San Jose
    3: Los Angeles
...
guillaume@ubuntu:~/$ ./102-relationship_cities_states_list.py root root hbtn_0e_101_usa
1: San Francisco -> California
2: San Jose -> California
3: Los Angeles -> California
4: Fremont -> California
